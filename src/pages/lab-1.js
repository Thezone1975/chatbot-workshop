...
const SecondPage = () => (
  <Layout>
    ...
    <ol>
      <li>Register with IBM Cloud by clicking on <a href="https://cocl.us/CB0103EN_BM" target="_blank" rel="noopener noreferrer">this link</a>.</li>
    ...
    <p>
      You can access this page at any time by logging in on the ibm.com/cloud site, but I highly recommend that you just bookmark the <a href="https://console.bluemix.net/dashboard/apps/" target="_blank" rel="noopener noreferrer">dashboard page</a> instead. It will give you quick access to seeing and managing all the resources you created inside of your IBM Cloud account.
    </p>
    ...
    <p><a href="https://cognitiveclass.ai/courses/how-to-build-a-chatbot/" target="_blank" rel="noopener noreferrer"><img src={courseImage} alt="Chatbot Course banner" style={{float: "right", margin: "20px"}} /></a>Last year, I created a chatbot course that's been taken by about 50,000 people around the world. You can think of this workshop as a more in depth, up to date, and interactive version of my online course available on <a href="https://cognitiveclass.ai" target="_blank" rel="noopener noreferrer">CognitiveClass.ai</a>.
    </p>
    <p>You don't need to take the course, since you're getting the in-person workshop which covers the same material and more; however, you should still sign up for Cognitive Class and enroll in my course now.</p>
